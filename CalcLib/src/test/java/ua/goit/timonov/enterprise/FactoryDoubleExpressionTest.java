...
public class FactoryDoubleExpressionTest {
    FactoryExpression factoryExpression = new FactoryDoubleExpression();

    @Test
    public void testParseNormal_1() throws Exception {
        StringExpression stringExpression = new StringExpression("+", "1.75", "3.75");
        ExpressionDoublePlusMinus actual = (ExpressionDoublePlusMinus) factoryExpression.makeExpression(stringExpression);
