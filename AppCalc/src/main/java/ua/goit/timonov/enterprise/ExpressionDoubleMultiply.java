 ...
 */
public class ExpressionDoubleMultiply implements Expression<Double, Double> {
    private Double value1;
    private Double value2;
    private Double result;

    public ExpressionDoubleMultiply() {
    }

    public ExpressionDoubleMultiply(Double value1, Double value2) {
        this.value1 = value1;
        this.value2 = value2;
    }
