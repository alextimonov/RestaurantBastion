...
<head>
    ...
    <title>Bastion|Service|Edit ingredient in dish</title>
</head>
<body>

<div class="container">
    <h2>Edit ingredient in dish ${dish.name}</h2>
    <c:url var="saveUrl" value="${pathDish}/${dish.id}/editItem?id=${item.id}"/>
    ...
    <form:form class="form-horizontal" modelAttribute="item" method="POST" action="${saveUrl}">
        <div class="form-group">
            <div class="col-sm-2">
                <label class="control-label" for="ingredient.id">ID</label>
            </div>
            <div class="col-sm-4">
                <form:input class="form-control" path="ingredient.id" disabled="true"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <form:input class="form-control" path="ingredient.name" type="text" disabled="true"/>
            </div>
            <div class="col-sm-4">
